...
1. 로그인 페이지
   ...
   ![a](.\exec\5.README\1.서비스 소개-3서비스 화면\a.png)

2. 메인페이지

   ![b](.\exec\5.README\1.서비스 소개-3서비스 화면\b.gif)

3. 회원정보 열람 및 수정페이지

   ![c](.\exec\5.README\1.서비스 소개-3서비스 화면\c.gif)

4. 다시보기 페이지

   ![d](.\exec\5.README\1.서비스 소개-3서비스 화면\d.gif)



## 4. UCC 영상

<video src=".\exec\5.README\구미_1반_D111_UCC경진대회.mp4"></video>
...
![WebRTC](.\exec\5.README\기술스택\WebRTC.png)
...
1. `스터디 모드` : `실제 면접`을 준비하기 위한 서비스
   ...
   1. **면접자 지정** 기능
      ...
      - 뷰들뷰들에서는 방장이 면접자를 지정할 수 있는 기능을 제공합니다. 면접실에 입장하기 전 **대기실에서 방장이 면접자를 지정**하고 면접 시작 버튼을 누르면 면접이 시작됩니다.![1-a](.\exec\5.README\3.면접스터디 서비스 소개\1-a.gif)
   ...
   2. **면접 영상 저장** 및 피드백 **타임라인 기능**
      ...
      - 이후, 면접이 끝난 후, 면접관은 **피드백실로 이동**하며, 방금 진행한 면접 영상을 보며 피드백을 수정할 수 있는 시간(5분)이 제공됩니다. 이때, 작성된 피드백의 재생 버튼을 클릭하면 **면접 영상은 피드백이 작성된 시점으로 이동**합니다.
        ...
        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\1-b-3.gif)
   ...
   3. Teachable machine을 이용한 **면접자 자세 평가 기능**
      ...
      - 사용자는 면접 이후 저장된 본인의 면접 영상에서 **자세 평가를 할 영역을 드래그**하여 사용할 수 있습니다.
        ...
        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\1-c.gif)
   ...
   4. 기타 기능
      ...
      - 방장에 의해 면접자로 지정되면 면접관들은 면접 진행 시에 **면접자의 자기소개서를 새 창에서 확인**할 수 있습니다.
        ...
        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\1-d.gif)
...
2. `플레이 모드` : 면접에 대한 `유쾌한 경험` 제공
   ...
   1. **키워드 인식**을 통한 FaceOverlay 기능
      ...
      - 면접자가 **빵** 이라는 키워드를 외칠 시에는 면접관의 얼굴에 **빵** 이미지를 Overlay 합니다.
        ...
        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-a-1.gif)

      - 면접자가 **감자**라는 키워드를 외칠 시에는 면접관의 얼굴에 **감자** 이미지를 Overlay 합니다.

        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-a-2.gif)

      - 면접자가 **나 안해**라는 키워드를 외칠 시에는 면접관의 얼굴에 **대머리** 이미지를 Overlay 합니다.

        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-a-3.gif)
   ...
   2. **돌발 질문 기능**
      ...
      - 면접관 중 한 명이 돌발 질문 기능을 클릭할 시, 해당 면접관 및 다른 면접관들의 돌발 질문 및 돌발 상황 버튼이 **비활성화** 됩니다.
        ...
        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-b-1.gif)

      - 면접자에게는 3초간 **배경화면 전환을 제공**하여, 돌발 질문 기능이 실행되었음을 알려줍니다.

        ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-b-2.gif)
      ...
      - 면접자에게는 게임 화면을 제공합니다
        ...
        - 1 to 9 게임
          ...
          - 제한 시간 내에 1부터 9까지의 숫자를 클릭하도록 하는 게임입니다.
            ...
            ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-c-1.gif)

        - 방향키 게임

          - 제한 시간 내에 화면에 표시되는 방향키를 순차적으로 누르는 게임입니다.

            ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-c-2.gif)

        - 연타 게임

          - 제한 시간 내에 스페이스바를 연타해 화면에 차오르는 물을 제거하는 게임입니다.

            ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-c-3.gif)
   ...
   4. 면접자 **쫓아내기 기능**
      ...
      ![1-a](.\exec\5.README\3.면접스터디 서비스 소개\2-d.gif)
...
![2-a](.\exec\5.README\4.프로젝트 진행\2-a.gif)
...
4. 번다운차트
   ...
   ![2-a](.\exec\5.README\4.프로젝트 진행\2-b-4-a.png)

   b. 2주차

   ![2-a](.\exec\5.README\4.프로젝트 진행\2-b-4-b.png)

   c. 3주차

   ![2-a](.\exec\5.README\4.프로젝트 진행\2-b-4-c.png)

c. GIT

git에 익숙치 않은 팀원들을 위해 Git 참고자료 전용 notion페이지를 따로 구성하여 모두 꼬임없이 git을 사용할 수 있도록 노력하였습니다.

![2-a](.\exec\5.README\4.프로젝트 진행\2-c-1.png)

또한 우리 팀만의 깃 규칙을 정하여 커밋 메세지와 브랜치관리를 더욱 간결하고 가독성 있게 관리였습니다.

![2-a](.\exec\5.README\4.프로젝트 진행\2-c-2.gif)

## **Ⅴ. UI / UX 및 시스템 아키텍쳐**

### **1. 와이어프레임**

![WebRTC](.\exec\5.README\기술스택\목업1.png)

![WebRTC](.\exec\5.README\기술스택\목업2.png)

### **2. 목업**

![WebRTC](.\exec\5.README\기술스택\목업3.png)![WebRTC](.\exec\5.README\기술스택\목업4.png)
...
![WebRTC](.\exec\5.README\기술스택\시스템아키텍쳐.png)
