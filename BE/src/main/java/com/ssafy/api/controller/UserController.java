...
public class UserController {
	...
	public ResponseEntity<? extends BaseResponseBody> register(
		...
		try {
			User user = userService.createUser(registerInfo.getUserEmail(), registerInfo.getUserName(), registerInfo.getUserPassword(), registerInfo.getUserPassword2());
			Common common = commonService.getCommonBySeq(3);
